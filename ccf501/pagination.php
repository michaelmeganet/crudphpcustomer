...
$rowCounter = $objCustomer->customer_list_numrows();
#echo $rowCounter."<br>";
...
echo " Page {$page} of {$totPages}. Displaying {$firstRecord}-{$lastRecord} of {$rowCounter} results.";
if($page<$totPages){    //--> create next & last button if not last page
	echo "<a href='{$pageurl}page={$nextPage}'>  >  </a>";
	echo "<a href='{$pageurl}page={$totPages}'> >></a>";
}
echo "</div><br>";
