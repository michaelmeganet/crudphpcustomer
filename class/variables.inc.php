...
Class SQLBINDPARAM extends SQL {
    ...
    public function InsertData2() {
        ...
        unset($bindparamArray['create_customer']);
...
//        $para = "";
        ...
        foreach ($bindparamArray as $key => $value) {
            ...
            $bindParamdata = "bindParam(\':$key\', $value)";
...
//        echo "\$para is listed as below :-<br> $para <br>";
        ...
        $stmt->bindParam(":telephone_sales", $telephone_sales);
        $stmt->bindParam(":fax_sales", $fax_sales);
        $stmt->bindParam(":handphone_sales", $handphone_sales);
        $stmt->bindParam(":email_sales", $email_sales);
        $stmt->bindParam(":attn_sales", $attn_sales);
        $stmt->bindParam(":telephone_acc", $telephone_acc);
        $stmt->bindParam(":fax_acc", $fax_acc);
        $stmt->bindParam(":handphone_acc", $handphone_acc);
        $stmt->bindParam(":email_acc", $email_acc);
        $stmt->bindParam(":attn_acc", $attn_acc);
        $stmt->bindParam(":groups", $groups);
        $stmt->bindParam(":aid_cus", $aid_cus);
        ...
        $stmt->bindParam(":credit_used", $credit_used);
        $stmt->bindParam(":one_do_one_inv", $one_do_one_inv);
        $stmt->bindParam(":cannot_migrate", $cannot_migrate);
        $stmt->bindParam(":regular", $regular);
        $stmt->bindParam(":nobusy", $nobusy);
